...
SELECT DISTINCT
    CASE
        ...
        WHEN signale_par ~ 'patrouille JM' THEN 'Maria'
        WHEN signale_par ~ 'Mme Weber' THEN 'Weber'
        WHEN signale_par ~ 'Mme Rochat' THEN 'Rochat'
    ...
    CASE
        ...
        WHEN signale_par ~ 'patrouille JM' THEN 'Jean'
        WHEN signale_par ~ 'Mme Weber' THEN 'Lisa'
        WHEN signale_par ~ 'Mme Rochat' THEN 'Emilie'
